...
public enum Gezegen {
    MERCURY(1, 10.1, 1000.7, 5.0),
    VENUS(2, 90.2, 5000.8, 100.0),
    EARTH(3, 110.2, 5000.0, 5.0),
    MARS(4, 150.9, 3000.5, 5.0),
    JUPITER(5, 300.5, 10000.0, 0.7),
    SATURN(6, 1200.4, 55555.0, 0.4),
    URANUS(7, 122.5, 25000.0, 3.7),
    NEPTUNE(8, 2000.1, 20000.0, 0.3);
